  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200/80 shadow-xs p-5 sm:p-6 flex flex-col justify-between h-full relative overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-100">
        ...
        {/* Real-Time Ticking Drip Counter Pill */}
        {isLeak ? (
          <div className="bg-red-50 border border-red-200 rounded-xl px-3 py-1.5 flex items-center gap-2.5 self-start sm:self-auto transition-all shrink-0">
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl px-3 py-1.5 flex items-center gap-2.5 self-start sm:self-auto transition-all shrink-0">
            <span className="material-symbols-outlined text-emerald-600 text-[18px]">
              verified
            </span>
            <div className="flex flex-col text-right">
              <span className="text-xs font-bold text-emerald-800">100% Sealed Flow</span>
      ...
      <div className="relative my-2 sm:my-3 w-full bg-gradient-to-b from-slate-50/70 via-slate-50/30 to-transparent rounded-xl p-1 sm:p-3 flex-1 flex items-center justify-center overflow-hidden min-h-[180px] sm:min-h-[220px]">
        <svg
        ...
        >
          ...
          {/* Room Labels (Crisp & readable) */}
          <text x="250" y="125" textAnchor="middle" fill="#64748B" fontFamily="system-ui, sans-serif" fontSize="11" fontWeight="700" letterSpacing="0.05em">
            ZONE 1 · UTILITY
          </text>
          <text x="415" y="125" textAnchor="middle" fill="#64748B" fontFamily="system-ui, sans-serif" fontSize="11" fontWeight="700" letterSpacing="0.05em">
            ZONE 2 · IRRIGATION / YARD
          </text>
          <text x="590" y="125" textAnchor="middle" fill="#64748B" fontFamily="system-ui, sans-serif" fontSize="11" fontWeight="700" letterSpacing="0.05em">
            ZONE 3 · BATH / FIXTURES
          </text>

          {/* Street Meter Pit (Left) */}
          <rect x="55" y="210" width="60" height="35" rx="6" fill="#F8FAFC" stroke="#94A3B8" strokeWidth="2" />
          <circle cx="85" cy="227" r="11" fill="#FFFFFF" stroke="#0055CE" strokeWidth="2" />
          <circle cx="85" cy="227" r="4" fill="#0055CE" />
          <path d="M85 227 L89 223" stroke="#0055CE" strokeWidth="1.5" strokeLinecap="round" />
          <text x="85" y="260" textAnchor="middle" fill="#334155" fontFamily="system-ui, sans-serif" fontSize="10" fontWeight="700">
            STREET METER
          </text>
          <text x="85" y="198" textAnchor="middle" fill="#0055CE" fontFamily="system-ui, sans-serif" fontSize="10" fontWeight="800">
            {isLeak ? 'INFLOW 4.8 L/m' : 'INFLOW 1.8 L/m'}
          </text>
          ...
          <rect x="380" y="160" width="40" height="22" rx="4" fill="#EFF6FF" stroke="#2F6FED" strokeWidth="1.5" />
          <path d="M 393 171 H 407" stroke="#2F6FED" strokeWidth="2" strokeLinecap="round" />
          ...
          <path d="M 602 180 L 618 180 L 622 188 L 598 188 Z" fill="#94A3B8" />
          ...
          <path
            ...
            d="M 400 220 H 600"
            stroke={isLeak ? "#94A3B8" : "#2F6FED"}
            opacity={isLeak ? 0.6 : 1}
            strokeWidth={isLeak ? 5 : 6}
            strokeLinecap="round"
          />
          ...
          {isLeak ? (
            <g id="leakVisualGroup">
              ...
              <g filter="url(#shadowPin)" transform="translate(325, 48)">
                ...
                <text x="14" y="38" fill="#334155" fontFamily="system-ui, sans-serif" fontSize="10" fontWeight="600">
                  Zone 2 Irrigation line · 4.8 L/m escaping
                </text>
              </g>
            </g>
          ) : (
            ...
            <g transform="translate(320, 52)">
              ...
              <text x="36" y="21" fill="#065F46" fontFamily="system-ui, sans-serif" fontSize="12" fontWeight="800">
                Pipes Intact &amp; Optimal
              </text>
      ...
      <div className="flex items-center justify-between pt-2 border-t border-slate-100 text-xs text-slate-500">
        <span className="flex items-center gap-1.5 font-medium text-slate-700">
          <span className={`w-2 h-2 rounded-full ${isLeak ? 'bg-error' : 'bg-emerald-500'}`} />
          <span>
            {isLeak
